<?php 
    ...
    if(isset($_POST['get-item'])){
        ...
        echo '<script>alert("Getting item Successfull")</script>';
    }
...
<body class="bg-[#121C20] flex flex-col">
    ...
    <div class="flex">
        ...
        <div class="w-72 h-[500px] bg-[#1A262D] flex flex-col items-center justify-center rounded-lg mt-5 self-center">
            ...
            <input type="submit" name="add-item" value="Add Product" class="text-sm  font-bold bg-[#5CE796] rounded-lg w-32 px-2 py-1 self-center hover:bg-[#75E6A4]">
